...
dev.new()
pairs(cccma$rcm.c, main = 'CanRCM4 calibration', col = '#0000001A', diag.panel = panel.hist, upper.panel=panel.smooth, lower.panel=panel.smooth)
dev.new()
pairs(qdm.c, main = 'QDM calibration', col = '#0000001A', diag.panel = panel.hist, upper.panel=panel.smooth, lower.panel=panel.smooth)
dev.new()
pairs(mbcp.c, main = 'MBCp calibration', col = '#FF00001A', diag.panel = panel.hist, upper.panel=panel.smooth, lower.panel=panel.smooth)
dev.new()
pairs(mbcr.c, main = 'MBCr calibration', col = '#0000FF1A', diag.panel = panel.hist, upper.panel=panel.smooth, lower.panel=panel.smooth)
dev.new()
